...
ActiveRecord::Schema.define(version: 20160312233233) do
  ...
  add_index "notifications", ["snap_id"], name: "index_notifications_on_snap_id", using: :btree
  ...
  add_foreign_key "notifications", "snaps"
